...
public class Sintatico implements Constants {
    ...
    private boolean step() throws LexicalError, SyntaticError, SemanticError {
        ...
        if (x == EPSILON) {
            ...
            if (x == a) {
                ...
                throw new SyntaticError("Erro na linha "+ getLinha(currentToken.getPosition())  +" - encontrado " + currentToken.getLexeme() + " " + PARSER_ERROR[x], currentToken.getPosition());
            }
        }
	...
	private String getLinha(int posicao) {
		return String.valueOf(scanner.getInput()
